...
public class CustListView extends ListView implements OnScrollListener {
	...
	public void initBottomView() {
		if (footerView == null) {
			...
			footerView.setPadding(0, DataTools.dip2px(mContext, 10), 0,
	...
	public boolean isAtBottom() {
		...
		LogUtil.log("count" + count + ",," + "lastVisiblePosition"
				+ lastVisiblePosition);
		if (getLastVisiblePosition() == (getCount() - 1)
			...
			LogUtil.log("getHeight() " + getHeight() + ",,"
					+ "bottomChildView.getBottom()"
					+ bottomChildView.getBottom());
		}
		return result;
	}
	...
	public void onScrollStateChanged(AbsListView view, int scrollState) {
		if (scrollState == OnScrollListener.SCROLL_STATE_IDLE
			...
			if (footerView != null && footerView.getBottom() == getBottom()) {
				footerView.setText(R.string.hn_loading);
			}
		}
		if (scrollState == OnScrollListener.SCROLL_STATE_TOUCH_SCROLL) {
			footerView.setText(R.string.hn_news_load_more);
		}
	}
