...
import com.example.testanimset.R;
...
public class AppIntroExampleActivity extends Activity {
	...
	private void setCircleAnimation() {
		...
		animation.addPageAnimaition(new WoWoShapeColorAnimation(0, 0, 1,
				ContextCompat.getColor(this, R.color.gray), ContextCompat
						.getColor(this, R.color.light_blue),
				ColorChangeType.RGB, EaseType.Linear, true));
		animation.addPageAnimaition(new WoWoScaleAnimation(0, 0, 1, circleR * 2
				/ findViewById(R.id.circle).getWidth(), circleR * 2
				/ findViewById(R.id.circle).getHeight(), EaseType.EaseInBack,
				false));
	...
	private void setNightonkeAnimation() {
		ViewAnimation animation = new ViewAnimation(
				findViewById(R.id.nightonke));
		animation.addPageAnimaition(new WoWoTranslationAnimation(0, 0, 1,
				findViewById(R.id.nightonke).getTranslationX(), findViewById(
						R.id.nightonke).getTranslationY(), -screenW,
				findViewById(R.id.nightonke).getTranslationY(),
				EaseType.EaseInBack, false));
		wowo.addAnimation(animation);
	}
	...
	private void setPresentsAnimation() {
		...
		animation.addPageAnimaition(new WoWoTranslationAnimation(0, 0, 1,
				findViewById(R.id.presents).getTranslationX(), findViewById(
						R.id.presents).getTranslationY(), -screenW,
	...
	private void setBlueStickAnimation() {
		...
		animation.addPageAnimaition(new WoWoTranslationAnimation(0, 0, 1,
				findViewById(R.id.blue_stick).getTranslationX(), findViewById(
						R.id.blue_stick).getTranslationY(), blueStick
						.getTranslationX(), screenH, EaseType.Linear, false));
		wowo.addAnimation(animation);
	}
	...
	private void setOrangeStickAnimation() {
		...
		animation.addPageAnimaition(new WoWoTranslationAnimation(0, 0, 1,
				...
				findViewById(R.id.orange_stick).getTranslationY(), -screenW,
				orangeStick.getTranslationY(), EaseType.Linear, false));
		wowo.addAnimation(animation);
	}

	private void setWoWoAnimation() {
		ViewAnimation animation = new ViewAnimation(findViewById(R.id.wowo));
		animation.addPageAnimaition(new WoWoRotationAnimation(0, 0, 0, -20,
				findViewById(R.id.wowo).getPivotY(), 0, 0, -15,
				EaseType.EaseInBack, false));
		animation.addPageAnimaition(new WoWoRotationAnimation(0, 0, 1, -20,
				findViewById(R.id.wowo).getPivotY(), 0, 0, -150,
				EaseType.EaseInBack, false));
		animation.addPageAnimaition(new WoWoTranslationAnimation(0, 0, 1,
				findViewById(R.id.wowo).getTranslationX(), findViewById(
						R.id.wowo).getTranslationY(), -screenW / 3,
				findViewById(R.id.wowo).getTranslationY(), EaseType.EaseInBack,
				false));
		wowo.addAnimation(animation);
	}
	...
	private void setViewPagerAnimation() {
		...
		animation.addPageAnimaition(new WoWoRotationAnimation(0, 0, 0, -20,
				findViewById(R.id.viewpager).getPivotY(), 0, 0, 15,
				EaseType.EaseInBack, false));
		animation.addPageAnimaition(new WoWoRotationAnimation(0, 0, 1, -20,
				findViewById(R.id.viewpager).getPivotY(), 0, 0, 150,
				EaseType.EaseInBack, false));
		animation.addPageAnimaition(new WoWoTranslationAnimation(0, 0, 1,
				findViewById(R.id.viewpager).getTranslationX(), findViewById(
						R.id.viewpager).getTranslationY(), -screenW / 3,
	...
	private void setMusicStand() {
		...
		animation.addPageAnimaition(new WoWoTranslationAnimation(0, 0, 0.8f,
				screenW, musicStand.getTranslationY(), -screenW, musicStand
						.getTranslationY(), EaseType.Linear, false));
		animation.addPageAnimaition(new WoWoTranslationAnimation(1, 0, 0.5f, 0,
				0, 0, screenH, EaseType.Linear, false));
		wowo.addAnimation(animation);
	}
	...
	private void setMusicNotes() {
		...
		animation.addPageAnimaition(new WoWoTranslationAnimation(0, 0, 0,
				screenW, musicNotes.getTranslationY(), 0, 0, EaseType.Linear,
				true));
		animation.addPageAnimaition(new WoWoTranslationAnimation(0, 0.2f, 1,
				screenW, musicNotes.getTranslationY(), -screenW, musicNotes
						.getTranslationY(), EaseType.EaseOutBack, true));
		animation.addPageAnimaition(new WoWoTranslationAnimation(1, 0, 0.5f, 0,
				0, 0, screenH, EaseType.Linear, false));
		wowo.addAnimation(animation);
	}
	...
	private void setBigCloud() {
		ViewAnimation animation = new ViewAnimation(
				findViewById(R.id.big_cloud));
		animation.addPageAnimaition(new WoWoTranslationAnimation(0, 0, 0, 0,
				-screenH / 2, 0, 0, EaseType.EaseOutBack, true));
		animation.addPageAnimaition(new WoWoTranslationAnimation(1, 0, 1, 0,
				-screenH / 2, 0, screenH / 2, EaseType.EaseOutBack, true));
		animation.addPageAnimaition(new WoWoTranslationAnimation(2, 0, 1, 0, 0,
				-screenW, 0, EaseType.EaseInBack, false));
		wowo.addAnimation(animation);
	}

	private void setLittleCloud() {
		ViewAnimation animation = new ViewAnimation(
				findViewById(R.id.little_cloud));
		animation.addPageAnimaition(new WoWoTranslationAnimation(0, 0, 0, 0,
				-screenH / 2, 0, 0, EaseType.EaseOutBack, true));
		animation.addPageAnimaition(new WoWoTranslationAnimation(1, 0, 1, 0,
				-screenH / 2, 0, screenH / 2, EaseType.EaseOutBack, true));
	...
	private void setPath() {
		...
		path.cubicTo(xScale * (509 + xoff), yScale * (385 + yoff), xScale
				* (144 + xoff), yScale * (272 + yoff), xScale * (394 + xoff),
				yScale * (144 + yoff));
		path.cubicTo(xScale * (477 + xoff), yScale * (99 + yoff), xScale
				* (596 + xoff), yScale * (91 + yoff), xScale * (697 + xoff),
				yScale * (128 + yoff));
		path.cubicTo(xScale * (850 + xoff), yScale * (189 + yoff), xScale
				* (803 + xoff), yScale * (324 + yoff), xScale * (66 + xoff),
				yScale * (307 + yoff));

		pathView.setPath(path);
		ViewAnimation animation = new ViewAnimation(pathView);
		animation.addPageAnimaition(new WoWoPathAnimation(1, 0f, 1f,
				EaseType.Linear, true));
		animation.addPageAnimaition(new WoWoAlphaAnimation(2, 0, 1, 1, 0,
				EaseType.Linear, true));
		animation.addPageAnimaition(new WoWoTranslationAnimation(2, 0, 1, 0, 0,
				-screenW, 0, EaseType.Linear, true));
		wowo.addAnimation(animation);
	}

	private void setOptimized() {
		ViewAnimation animation = new ViewAnimation(
				findViewById(R.id.optimized));
		animation.addPageAnimaition(new WoWoTranslationAnimation(0, 0, 0,
				screenW, 0, 0, 0, EaseType.Linear, true));
		animation.addPageAnimaition(new WoWoTranslationAnimation(1, 0, 1,
				screenW, 0, -screenW, 0, EaseType.Linear, true));
		animation.addPageAnimaition(new WoWoTranslationAnimation(2, 0, 1, 0, 0,
				-screenW, 0, EaseType.Linear, true));
		wowo.addAnimation(animation);
	}
	...
	private void setSun() {
		...
		animation.addPageAnimaition(new WoWoTranslationAnimation(0, 0, 0,
				screenW, -screenW, 0, 0, EaseType.Linear, true));
		animation.addPageAnimaition(new WoWoTranslationAnimation(2, 0, 1,
				screenW, -screenW, -screenW, screenW, EaseType.Linear, true));
		animation.addPageAnimaition(new WoWoRotationAnimation(2, 0, 1,
				findViewById(R.id.sun).getPivotX(), findViewById(R.id.sun)
						.getPivotY(), 0, 0, 360 * 4, EaseType.EaseOutBack,
				false));
		wowo.addAnimation(animation);
	}
	...
	private void setNightonkeCloud() {
		ViewAnimation animation = new ViewAnimation(
				findViewById(R.id.nightonke_cloud));
		animation.addPageAnimaition(new WoWoTranslationAnimation(0, 0, 0,
				screenW, 0, 0, 0, EaseType.EaseOutBack, true));
		animation.addPageAnimaition(new WoWoTranslationAnimation(2, 0, 1,
				screenW, 0, -screenW, 0, EaseType.EaseOutBack, true));
		wowo.addAnimation(animation);
	}
}
