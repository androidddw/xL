...
public class WoWoViewPagerAdapter extends FragmentStatePagerAdapter {
	...
	public WoWoViewPagerAdapter(FragmentManager fm) {
		super(fm);
		fragments = new ArrayList<WoWoViewPagerFragment>();
	}
	 ...
	 * 
	 * @param colorRes
	 *            resource of color of fragments
	 */
	...
	public void setColorsRes(Integer[] colorsRes) {
		setColorsRes(new ArrayList<Integer>(Arrays.asList(colorsRes)));
	}
	 ...
	 * 
	 * @param colorsRes
	 *            resources of colors of fragments
	 */
	...
	public void setColors(Integer[] colors) {
		setColors(new ArrayList<Integer>(Arrays.asList(colors)));
	}
