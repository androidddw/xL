...
public class WoWoViewPager extends ViewPager {
	...
	/**
	 * get the starting page and the positionOffset to play all pageAnimations
	 * in each viewAnimation
	 * 
	 * @param position
	 *            start page
	...
	public void setScrollDuration(int scrollDuration) {
		...
		try {
			...
			WoWoScroller scroller = new WoWoScroller(this.getContext(),
